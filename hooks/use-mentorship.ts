...
export function usePendingApplications(params: { search?: string; industry?: string }) {
    return useQuery({
...
export function useEligibleMentors(params: { search?: string; industry?: string }) {
    return useQuery({
...
export function useEligibleMentorsForApplication(applicationId: number, enabled: boolean) {
    return useQuery({
...
export function useAssignMentor() {
    ...
    return useMutation({
        mutationFn: ({ applicationId, mentorId }: { applicationId: number; mentorId: number }) =>
...
export function useReassignMentor() {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: ({ applicationId, newMentorId }: { applicationId: number; newMentorId: number }) =>
